            ...
            <div class="col-lg-6 col-md-8 col-sm-centered">
                ...
                <div class="am-form-group">
                    <div class="col-sm-12">
                        <div style="width: 38px;height: 38px;float: left;">
                            <img src="assets/i/account.png"
                                 style="width: 2rem;height: 2rem;margin: 0.8rem 0.8rem 0.8rem 0.8rem;">
                        </div>
                ...
                <div class="am-form-group">
                    <div class="col-sm-12" style="text-align: center">
                        <button style="padding: .625em 4em;border-radius: 1rem" type="submit"
                                class="am-btn am-btn-default">授权
                        </button>
                    </div>
                </div>
            </div>
