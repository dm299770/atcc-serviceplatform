...
public class OauthConstants {
    ...
    public static int getReidsdb() {
        return reidsdb;
    }
    @Autowired(required = false)
    public static void setReidsdb(@Value("${spring.redis.database}")int reidsdb) {
        OauthConstants.reidsdb = reidsdb;
    }
}
